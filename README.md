...
3) Дистрибутив Windows XP 
   ...
   - [Magnet Link](magnet:?xt=urn:btih:3ce2e6690a9f78ea778f49586eda19cea83929a1&dn=ru_windows_xp_professional_with_service_pack_3_x86_cd_x14-80484.iso&tr=http%3a%2f%2fbt2.t-ru.org%2fann%3fpk%3d100aabcc77a46499d9eeb1f0b1e078d6&tr=http%3a%2f%2fretracker.local%2fannounce)
...
**Примечание:** *код скрипта по нахождению лучшего решения писался на скорую руку, если вы нашли неточности или хотите его улучшить, просьба сообщить об этом через issues/PR.*
...
2) При вводе данных в программу не предусмотрена возможность учета местоположения "наблюдателя", а также отсуствует поправка на смену календарей в период с 500 года д.н.э. по 2000 год н.э.;
