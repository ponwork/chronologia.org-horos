...
# Без предоставления указанных выше данных у меня есть все основания заявлять, что выводы, изложенные в "Новой Хронологии" Г.В. Носовского и А.Т. Фоменко являются результатом манипуляции и подтасовок и никакого отношения к реальным событиям истории Древнего мира не имееют.
